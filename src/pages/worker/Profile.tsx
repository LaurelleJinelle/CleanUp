...
import { UserIcon, MailIcon, PhoneIcon, TruckIcon, SaveIcon, BellIcon } from "lucide-react";
        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="border-t border-gray-200 pt-6">
            {isEditing ? <form onSubmit={handleSubmit}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input type="tel" id="phone" name="phone" value={formData.phone} onChange={handleChange} className="pl-10 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500" required />
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input type="text" id="vehicleId" name="vehicleId" value={formData.vehicleId} onChange={handleChange} className="pl-10 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500" required />
                      </div>
                    </div>
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <ProfileField icon={<PhoneIcon className="h-5 w-5 text-gray-400" />} label="Phone Number" value={user.phone} />
                  <ProfileField icon={<TruckIcon className="h-5 w-5 text-gray-400" />} label="Vehicle ID" value={user.vehicleId} />
                </div>
                <div>
                  <h4 className="text-base font-medium text-gray-800 mb-3 flex items-center">
                    <BellIcon className="h-5 w-5 text-blue-600 mr-2" />
