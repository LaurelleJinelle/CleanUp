...
const Workers = () => {
  ...
  const filteredWorkers = workers.filter((worker) => {
    ...
    if (
      ...
      !worker.vehicleId.toLowerCase().includes(searchQuery.toLowerCase())
    ) {
      return false;
    }
    return true;
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <div className="relative">
                ...
                <input
                  type="text"
                  className="pl-10 pr-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
              ...
              <div className="relative">
                <div className="flex items-center">
                  ...
                  <select
                    className="pl-2 pr-8 py-2 border border-gray-300 rounded-md shadow-sm text-gray-700 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                    value={filterStatus}
              ...
              {filteredWorkers.length > 0 ? (
                filteredWorkers.map((worker) => (
                  <tr key={worker.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span
                        className={`px-2 py-1 text-xs rounded-full ${getStatusColor(worker.status)}`}
                      >
