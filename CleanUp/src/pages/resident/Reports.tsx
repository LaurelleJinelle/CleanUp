  ...
  const recentReports = [
    {
      ...
      date: "2023-10-05",
      description:
        "My recycling bin was not emptied during the scheduled collection.",
    },
    {
      id: 2,
      type: "Damaged Bin",
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {reportTypes.map((type) => (
                    <div key={type.id}>
                      ...
                      <label
                        htmlFor={type.id}
                        className={`block w-full py-3 px-4 text-center border rounded-md cursor-pointer text-sm ${formData.type === type.id ? "bg-blue-50 border-blue-200 text-blue-700" : "border-gray-200 text-gray-700 hover:bg-gray-50"}`}
                      >
                        {type.label}
                      </label>
                    </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="pl-10 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
              ...
              <div>
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex items-center justify-center w-full bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50"
                >
                  {submitting ? (
                    "Submitting..."
                  ) : (
                ...
                recentReports.map((report) => (
                  ...
                  >
                    <div className="flex justify-between items-start">
                      ...
                      <span
                        className={`text-xs px-2 py-1 rounded-full ${report.status === "Resolved" ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"}`}
                      >
                        {report.status}
                      </span>
                    </div>
