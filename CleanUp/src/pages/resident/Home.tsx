    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <DashboardCard
          ...
          linkTo="/resident/schedule"
        >
          <div className="space-y-3">
            {nextCollections.map((collection) => (
              <div key={collection.id} className="flex items-start">
        ...
        <DashboardCard
          ...
          linkText="View Map"
          linkTo="/resident/collection-points"
        >
          <div className="space-y-3">
...
const DashboardCard = ({ title, icon, children, linkText, linkTo }) => {
  return (
    <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
      ...
      <div className="px-6 py-3 bg-gray-50 border-t border-gray-100">
        <Link
          to={linkTo}
          className="text-sm text-blue-600 font-medium hover:text-blue-500 flex items-center"
        >
          {linkText}
