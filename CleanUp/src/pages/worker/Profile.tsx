                ...
                <div>
                  ...
                  <ul className="space-y-1 text-sm text-gray-600">
                    <li className="flex items-center">
                      <span
                        className={`h-2 w-2 rounded-full mr-2 ${user.notificationPreferences.email ? "bg-green-500" : "bg-gray-300"}`}
                      ></span>
                      Email notifications:{" "}
                    ...
                    <li className="flex items-center">
                      <span
                        className={`h-2 w-2 rounded-full mr-2 ${user.notificationPreferences.sms ? "bg-green-500" : "bg-gray-300"}`}
                      ></span>
                      SMS notifications:{" "}
                    ...
                    <li className="flex items-center">
                      <span
                        className={`h-2 w-2 rounded-full mr-2 ${user.notificationPreferences.app ? "bg-green-500" : "bg-gray-300"}`}
                      ></span>
                      In-app notifications:{" "}
                      {user.notificationPreferences.app
                        ? "Enabled"
                        : "Disabled"}
                    </li>
                  </ul>
