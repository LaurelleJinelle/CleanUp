        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-4">
            ...
            <div className="space-y-2">
              <button
                className={`w-full p-3 rounded-lg text-left ${selectedRoute === "today" ? "bg-blue-50 border border-blue-200" : "hover:bg-gray-50 border border-gray-100"}`}
                onClick={() => setSelectedRoute("today")}
              >
              ...
              <button
                className={`w-full p-3 rounded-lg text-left ${selectedRoute === "tomorrow" ? "bg-blue-50 border border-blue-200" : "hover:bg-gray-50 border border-gray-100"}`}
                onClick={() => setSelectedRoute("tomorrow")}
              >
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <div className="flex items-center">
                        ...
                        <span
                          className={`ml-2 text-xs px-2 py-0.5 rounded-full ${getStatusColor(stop.status)}`}
                        >
                          {stop.status}
                        </span>
                      </div>
